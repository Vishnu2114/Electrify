...
<p>&nbsp;</p>
<p>&nbsp;</p>
<div class="search-table-container-m">
    <table class="search-table">
        <tr>
        <th>Category</th>
        <td><label for="btn_category"></label>
            <select name="btn_category" required id="btn_category" class="dropdown" onchange="getProduct()">
        ...
        <td><label for="btn_brand"></label>
            <select name="btn_brand" required id="btn_brand" class="dropdown" onchange="getProduct()">
            <option value="">Select</option>
                <?php
